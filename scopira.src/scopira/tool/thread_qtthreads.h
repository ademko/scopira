  ...
  public virtual scopira::tool::runnable_i
{
  ...
  protected:
    ...
    {
      public:
        myQThread(scopira::tool::thread *parent) : dm_parent(parent) { }
      protected:
        virtual void run(void) { dm_parent->run(); }
      private:
        scopira::tool::thread *dm_parent;
    } dm_thread;
  ...
  public:
    ...
    SCOPIRA_EXPORT virtual bool is_running(void) const { return dm_thread.isRunning(); }
    ...
    /**
      ...
      * @author Aleksander Demko
      */
    SCOPIRA_EXPORT static void set_tls(tlskey_t k, void *val);
    /**
